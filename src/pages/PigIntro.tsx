...
export default function PigIntro() {
  ...
  const darkBoxStyle: React.CSSProperties = {
    backgroundColor: "#070971", // deep blue info box
    borderColor: TEXT_DARK,
  };
      ...
      >
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <p className="text-white/85 text-sm md:text-base max-w-prose">
            Fast, competitive, and all about precision.
          </p>
        </div>
        ...
        >
          ...
          <ul className="space-y-2 text-sm leading-6 text-white/90">
            <li>
              • Make as many shots as possible — each make = <b>+5 XP</b>.
            </li>
            <li>
              • Miss a shot? You earn a letter: <b>P → PI → PIG</b>.
            </li>
            <li>• Game ends after three total misses.</li>
            <li>• Accuracy, XP, and streaks update live as you play.</li>
